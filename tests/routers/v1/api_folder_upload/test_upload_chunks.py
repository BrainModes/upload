...
async def test_upload_chunks_return_400_when_session_id_header_is_missing(
...
async def test_upload_chunks_return_200_when_when_success(
    test_async_client, httpx_mock, create_fake_job, clean_job_from_redis, create_job_folder
):
    response = await test_async_client.post(
        '/v1/files/chunks',
