...
async def async_session_job_get_status(session_id, job_id, project_code, action, operator=None):
    '''
    get session job status from datastore
    '''
    return await run_in_threadpool(
        session_job_get_status, session_id, job_id, project_code, action, operator=operator
    )
