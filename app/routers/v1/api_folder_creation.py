...
from app.models.models_upload import CreateFolderPOST, CreateFolderPOSTResponse, BulkCreateFolderPOST, BulkCreateFolderPOSTV2
from app.resources.error_handler import catch_internal, EAPIResponseCode, ECustomizedError, customized_error_template
from app.resources.helpers import get_geid, bulk_get_geid
from app.resources.lock import lock_resource, unlock_resource
        ...
        try:
            ...
            if destination_geid is not None:
                ...
                if respon_query.status_code == 200 and len(respon_query.json()) != 0:
                    ...
                    # neo4j_zone_label = ConfigClass.GREEN_ZONE_LABEL if ConfigClass.GREEN_ZONE_LABEL in respon_query[0]['labels']\
                    #     else ConfigClass.CORE_ZONE_LABEL
            else:
                return
